...
fill(#A839C1);
 ...
 fill(#56D1B7);
 ellipse(250,275,150,150);//BODY
 fill(#9356D1);
 ellipse(250,450,200,200);//BODY
 fill(#EA0296);
 ellipse(250,275,10,10);//BUTTON
 ellipse(250,300,10,10);//BUTTON
 ellipse(250,250,10,10);//BUTTON
 fill(#221F24);
 ellipse(225,150,10,10);//EYE
 ellipse(255,150,10,10);//EYE
 fill(;
triangle(245,160,245,170,220,175);
